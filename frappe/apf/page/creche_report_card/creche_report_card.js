        ...
        Object.keys(data).filter(colKey => colKey !== 'Col0').forEach((colKey) => {
            ...
            data[colKey].forEach(item => {
                ...
                // for gmd
                    ...
                    extraLine = `<div style="font-size: 10px; color: #000; font-style:italic; font-weight:600;">(${isNaN(percentage) ? 0 : percentage.toFixed(1)} % of children measurement taken)</div>`;
                }
