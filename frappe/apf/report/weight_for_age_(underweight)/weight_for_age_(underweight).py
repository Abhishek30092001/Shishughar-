...
def execute(filters=None):
    ...
    fixed_columns = [
        ...
        {"label": "Retained in the Severe category in this month", "fieldname": "cq_sv_2_cnt", "fieldtype": "Int", "width": 450},
...
def get_report_data(filters):
    ...
    query = f"""
        ...
        LEFT JOIN (
            ...
            GROUP BY partner_id,state_id,district_id,block_id,gp_id,creche_id
